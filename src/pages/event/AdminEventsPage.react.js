  ...
  return events.map((event) => {
    ...
    return (
      <Table.Row>
        ...
        <Table.Col>{event.year}</Table.Col>
        <Table.Col>
          <Button RootComponent="a" colors="info" href={`event-management/${event.id}`}><Icon prefix="fe" name="arrow-right"/></Button>
        </Table.Col>
      </Table.Row>
    )
  })
            ...
            <Table cards={true}>
              <Table.Header>
                <Table.Row>
                  ...
                  <Table.ColHeader>
                    Năm <Button className="ml-3" size="sm"><Icon prefix="fe" name="arrow-down"/></Button>
                  </Table.ColHeader>
